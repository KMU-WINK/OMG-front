            ...
            <Header title={'비밀번호 변경하기'}/>
            {
                pageNum === 1 ?
                    <style.Contents>
                        ...
                        <Input title={'이름'} name={"name"} value={Form.name} onChange={handleOnChange}/>
                        <Input title={'전화번호'} name={"phone"} value={Form.phone} onChange={handleOnChange}/>
                        <Input title={'이메일'} name={"email"} value={Form.email} onChange={handleOnChange}/>
                        <FullButton btnName={'인증번호 발급받기'} onClick={HanldlePasswordChange} id={"serial"}/>
                    </style.Contents>
                    :
                    <style.Contents>
                        <style.SubTitle>인증 후 새로운 비밀번호로 변경이 가능합니다.</style.SubTitle>
                        <Input title={'인증번호 입력'} name={"code"} value={change.code} onChange={handleOnChangePW}/>
                        <Input title={'새로운 비밀번호 입력'} name={"password"} value={change.password} onChange={handleOnChangePW}/>

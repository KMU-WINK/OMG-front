...
import {Contents, Glass, InfoWrap, Row, Title, TopWrap, Wrapper} from "./styles";
    ...
    return (
        <Wrapper>
            <TopWrap>
                ...
                <div>이유빈님 안녕하세요<br /> 공병 등록을 시작해 볼까요?</div>
            ...
            <InfoWrap>
                ...
                <div>
                    수거를 원하는 공병은 집 문앞에 놓아주세요.
                    출입이 제한되는 회사, 학교, 기숙사 등의 장소나 비밀번호 오류등의 사유로 출입이 어려운 경우 부득이하게 수거가 불가능할 수 있습니다.
                </div>

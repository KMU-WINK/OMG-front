            ...
            </Flex>
            {
                props.del ?
                    <div>
                        {
                            delNoti ?
                                <img src={process.env.PUBLIC_URL + '/images/Common/checkedR.svg'} onClick={()=> setDelNoti(false)}/>
                                :
                                <img src={process.env.PUBLIC_URL + '/images/Common/uncheckedR.svg'} onClick={()=> setDelNoti(true)}/>
                        }
                    </div>
                : null
            }

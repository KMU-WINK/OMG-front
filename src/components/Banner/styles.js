...
export const banner = styled.div`
    ...
    background: ${props => {
        ...
        if (props.styleSoju) return 'conic-gradient(from 180deg at 50% 50%, #009800 0deg, #FFFFFF 360deg);'
        if (props.styleBeer) return 'conic-gradient(from 180deg at 50% 50%, #A95C01 0deg, rgba(169, 92, 1, 0) 360deg);'
        if (props.styleEtc) return 'conic-gradient(from 180deg at 50% 50%, #D2D2D2 0deg, rgba(210, 210, 210, 0) 360deg);'
